...
/**
 * Centralized UDT conversion utility.
 * Ensures consistent UDT ↔ Map conversion across ingest and query services.
 */
public class UdtMapper {
     ...
     * Handles BigDecimal, Instant, String parsing, and nested UDTs.
     * 
     ...
     */
    public static UdtValue toUdt(CqlSession session, String keyspace, String udtName, Map<String, Object> data) {
     ...
     */
    private static UdtValue setUdtField(CqlSession session, String keyspace, UdtValue udtValue,
    ...
    /**
     * Converts a UdtValue to a Map.
     * Recursively handles nested UDTs for clean JSON serialization.
     * 
